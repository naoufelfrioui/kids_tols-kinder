...
export class AccountPage {
  ...
  constructor(public navCtrl: NavController,
    ...
    let self = this;
    this.attributes = [];
    this.avatarPhoto = 'https://scontent.xx.fbcdn.net/v/t1.0-9/12009790_768575529917832_1891406853874564995_n.jpg?oh=0e34f4fa935f34ee82a7dfff1e759fbf&oe=59CF8001';
